...
<body>
	...
	%>
	<center>
	<form action="admin_guojiadaimabiaoshanchu.jsp" method=post name="chaxuntiaojian">
		<table>
			<p>
	...
	%>
		...
		<%
		stmtdelete.executeUpdate("delete from countrycodes where "+chaxunbiaozhun+"='"+chaxuntiaojian+"'");
