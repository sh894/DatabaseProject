  ...
  <body>
  	<%
		...
		Statement stmtinsert = conn.createStatement(
				...
				stmtdelete.executeUpdate("delete from countrycodes where country='"+request.getParameter("oldcountry")+"'");
				stmtinsert.executeUpdate("insert into countrycodes values('"+request.getParameter("countryno")+"','"+request.getParameter("country")+"')");
				
				out.println("修改成功");
				System.out.println(request.getParameter("countryno"));
					System.out.println(request.getParameter("country"));
					System.out.println(request.getParameter("oldcountryno"));
					System.out.println(request.getParameter("oldcountry"));
	%>
