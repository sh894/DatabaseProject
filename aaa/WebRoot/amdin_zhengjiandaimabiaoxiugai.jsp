...
<body>
	...
	%>
	<form action="root_zhengjiandaimabiaoxiugai.jsp" method=post
		name="chaxuntiaojian">
		<table>
			<p>
	...
	%>
	<%
		sql = "select * " + "from certclasses " + "where "
	...
	<form action="admin_zhengjiandaimabiaoxiugai_action.jsp" method="post">
		<table width="400" align="center" border="1">
			<tr>
				<td width="100">旧证件代码：</td>
				<td>&nbsp;<input type="text" name="oldcertno" width="15"
					value=<%=rs.getString("certno")%> /></td>
			</tr>
			<tr>
				<td width="100">旧证件名称：</td>
				<td>&nbsp;<input type="text" name="oldcertclass" width="15"
					value=<%=rs.getString("certclass")%> /></td>
			</tr>
			<tr>
				<td width="100">新证件代码：</td>
				<td>&nbsp;<input type="text" name="certno" width="15" /></td>
			</tr>
			<tr>
				<td width="100">新证件名称：</td>
				<td>&nbsp;<input type="text" name="certclass" width="15" /></td>
			</tr>
			<tr>
